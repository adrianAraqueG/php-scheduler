                    ...
                    <?php
                        ...
                        for($i = 6; $i < 21; $i++){
                            echo "<tr>";
                                ...
                                for($f = 0; $f < 7; $f++){
                                    echo "<td class='". $user_schedule->{$days[$f]}->{$i}->{'cell-color'} ."' id='". $days_cut[$f] ."-". $i ."' onclick=edit('". $days_cut[$f] ."-". $i ."') type='button' data-bs-toggle='modal' data-bs-target='#modal'>";
                                        echo "<div class='d-flex flex-row justify-content-between'>";
                                            echo $user_schedule->{$days[$f]}->{$i}->title;

                                            if($user_schedule->{$days[$f]}->{$i}->markup != 0){
